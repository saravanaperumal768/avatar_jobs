...
$sql = "SELECT id, clientname, job, members, notes, completion, time_comp, reference, entry_date, assigned_by, job_status, close_time, cus_date  FROM jobcreate WHERE assigned_by ='$name_member'"  ; // Replace 'your_table' with your actual table name
// echo $sql;
// exit;
$result = $db->query($sql);
