...
if ($_POST["Submit"]=="Add"){
   ...
   $sql = "INSERT INTO job_type (job_type)
   VALUES ('$job_type')";
...
$update_sql = "UPDATE job_type SET 
               job_type = '$job_type'
...
if($result){
    echo '<script>alert("Job Type Updated");</script>';
     
    echo '<script>window.location.href = "job_type.php";</script>'; 
}
...
@media(max-width:991px){
    ...
    <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="card-header d-flex justify-content-between">
                     <div class="header-title">
                        <h4 class="card-title">ADD/EDIT JOB TYPE List</h4>
                     </div>
        ...
        <form action="job_type.php"  method="post" enctype="multipart/form-data" id="add_product" onSubmit="return validate();">   
                  <div class="card-body">
                  <!-- action="iteration_data.php" method="POST" -->
                     <form   method="post">

                     <input name="id1" type="hidden" id="id1" value="<?php echo $_REQUEST["job_type_id"]; ?>" />
                     <input type="hidden" name="submit_name" value="<?php echo $name_member;?>" >
                        <div class="row"> 
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                    <label for="exampleInputText1">Job_type </label>
                                    <input type="text" class="form-control" id="job_type" name="job_type" value="<?php echo $_REQUEST["job_type"]; ?>" >
                                    </div>
                                </div>
 ...
 {?>
    ...
    <input name="Submit" type="submit" class="btn btn-danger" id="Submit" value="Update" />
							...
							{
							?>
                                                      <input name="Submit2" type="reset" class="btn btn-danger" value="Add New" onClick="location.replace('job_type.php?bid=sav')" />
                                                      <?php 
 ...
 ?>
                                                      <input name="Submit" type="reset" class="btn btn-danger" value="Reset" onClick="location.replace('job_type.php?bid=sav')" /></label></div>
                  ...
                  <div class="card card-block card-stretch">
                            ...
                            <div class="d-flex justify-content-between align-items-center p-3">
                                    <h5 class="font-weight-bold"> Job Type List</h5>
                            ...
                            $sql2 = "SELECT * FROM job_type ORDER BY job_type_id  ASC";
                                ...
                                while ($db_field2 = mysqli_fetch_array($result2)) {
                                   $id =$db_field2["id"];
                                    ...
                                    ?>  
                                     ...
                                     <td><?php echo $db_field2["job_type"] ?> </td>
                                           ...
                                           <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <?php
                                                    echo "<a href='job_type.php?bid=up&job_type_id=" . $db_field2["job_type_id"] . "&job_type=" . $db_field2["job_type"] . "' target='_parent'>";
                                                    ?>
                                                    ...
                                                    <input type="hidden" name="job_id" value="<?php echo $db_field2['job_type_id']; ?>">
