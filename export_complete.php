...
$sql = "SELECT id, clientname, job, members, notes, completion, time_comp, reference, entry_date, assigned_by, filelink, job_close_file, job_close_file, job_status, close_time, cus_date FROM jobcreate Where  job_status ='Closed Completed'"; 
$result = $db->query($sql);
